  ...
  return (
    <ReactMarkdown
      ...
      components={{
        ...
        h2: ({ children }) => <h2 className="text-2xl font-mono font-bold text-foreground mb-3 mt-6">{children}</h2>,
        h3: ({ children }) => <h3 className="text-xl font-mono font-bold text-foreground mb-2 mt-4">{children}</h3>,
