      ...
      <div className="min-h-screen bg-background">
                ...
                <Card key={recipe.id}>
                  <CardContent className="p-6">
                    <div className="flex gap-6">
                      <div className="h-32 w-32 flex-shrink-0 rounded-lg bg-muted flex items-center justify-center text-7xl">
                        {recipe.emoji}
                      </div>
                      ...
                      <div className="flex flex-col gap-2">
                        <Button variant="outline" size="sm" onClick={() => handleEdit(recipe)} className="font-mono">
        ...
        <AlertDialog open={!!recipeToDelete} onOpenChange={() => setRecipeToDelete(null)}>
          <AlertDialogContent>
            <AlertDialogHeader>
              ...
              <AlertDialogDescription>
                ¿Estás seguro de que quieres eliminar "{recipeToDelete?.title}"? Esta acción no se puede deshacer.
              </AlertDialogDescription>
            </AlertDialogHeader>
            <AlertDialogFooter>
        ...
        <footer className="border-t border-border mt-16 py-8">
          <div className="container mx-auto px-4 text-center text-sm text-muted-foreground font-mono">
            <p>TofuBase - Hecho con plantas y código</p>
          </div>
        </footer>
      </div>
    </ProtectedRoute>
