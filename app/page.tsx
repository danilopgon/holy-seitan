      ...
      <main className="container mx-auto px-4 py-8">
        ...
        <div className="mb-12 text-center">
          ...
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
            Una colección de deliciosas recetas a base de plantas impulsada por la comunidad. Descubre, comparte y
        ...
        {filteredRecipes.length === 0 && (
          <div className="text-center py-12">
            <p className="text-muted-foreground font-mono">No se encontraron recetas. Intenta ajustar tus filtros.</p>
          </div>
        )}
      </main>
